...
def test():
    with open('knn_model_148064.pkl', 'r') as input_file:
    ...
    prec, recall, f1, support = precision_recall_fscore_support(Y, Y_pred, average='micro')
    print 'Precision micro: ',prec
    print 'Recall: ',recall
    print 'F1 Score: ',f1
    print 'Support: ',support

    prec, recall, f1, support = precision_recall_fscore_support(Y, Y_pred, average='weighted')
